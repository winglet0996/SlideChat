...
lora_r = 128
lora_alpha = 128
run_suffix = 'regsampler'

if setting == 'alignment':
    llm_lora = None
    freeze_llm = True
    lr = 2e-4  # Reduced from 1e-4 for better stability
    # ckpt_path = None
    ckpt_path = '/mnt/petrelfs/zhaoweike/project/TCGA/9B_multimodal_alignment_wo_knowledge_v13_8token_4wsi_linear_hs_0p5_0_0p5_regsampler/iter_3000.pth'
    max_epochs = 3
...
if setting == 'lora':
    ...
    save_best_metrics = None
    # ckpt_path = None
    ckpt_path = '/mnt/petrelfs/zhaoweike/project/TCGA/9B_multimodal_alignment_wo_knowledge_v13_8token_4wsi_linear_hs_0p5_0_0p5_regsampler/iter_19440.pth'
    lr = 3e-5
    freeze_llm = True
    max_epochs = 3
