...
ckpt_path = '/mnt/petrelfs/zhouxiao/project/TCGA/train_capgen_qwen3_8b_conv_qformer_q1024_alignment/iter_839.pth'
# ckpt_path = None
# ckpt_out_path = 's3://zhouxiao/ckpt'
ckpt_out_path = None
resume = False

# save_best_metrics = ['eval/diag_accuracy', 'eval/full_ROUGE-L']
save_best_metrics = None

work_dir = f'/mnt/petrelfs/zhouxiao/project/TCGA/train_capgen_qwen3_8b_conv_qformer_{setting}/'
vis_name = f'qwen3_8b_conv_qformer_{setting}'

val_output_path = work_dir + 'val_results'
test_output_path = work_dir + 'test_results_iter_4000_sample'
