...
setting = 'lora'
work_dir = f'/mnt/petrelfs/zhouxiao/project/TCGA/train_mcqa_qwen3_8b_conv_no_knowledge_{setting}/'
vis_name = f'qwen3_8b_conv_no_knowledge_{setting}'
...
if setting == 'lora':
    ...
    ckpt_path = '/mnt/petrelfs/zhouxiao/project/TCGA/train_mcqa_qwen3_8b_conv_no_knowledge_lora/iter_500.pth'
    lr = 1e-5
    freeze_llm = True
    max_epochs = 3
...
train_data_path = f'/mnt/petrelfs/zhouxiao/project/TCGA/dataset_pp/PathoVerse_stage2_mcqa_train_no-knowledge.json'
val_data_path = '/mnt/petrelfs/zhouxiao/project/TCGA/dataset_pp/PathoVerse_stage2_mcqa_test_no-knowledge_eval_800.json'
test_data_path = f'/mnt/petrelfs/zhouxiao/project/TCGA/dataset_pp/PathoVerse_stage2_mcqa_test_no-knowledge.json'

# ckpt_out_path = 's3://zhouxiao/ckpt'
ckpt_out_path = None

val_output_path = work_dir + 'val_results'
test_output_path = work_dir + 'test_results_iter_37500'
