...
if setting == 'lora':
    ...
    ckpt_path = '/mnt/petrelfs/zhouxiao/project/TCGA/train_mcqa_qwen3_8b_conv_qformer_alignment_Diagnosis/iter_500.pth'
    lr = 1e-5
    freeze_llm = True
    max_epochs = 3
...
train_data_path = f'/mnt/petrelfs/zhouxiao/project/TCGA/dataset_pp/PathoVerse_train_stage2_mcqa_train_{cat}.json'
val_data_path = '/mnt/petrelfs/zhouxiao/project/TCGA/dataset_pp/PathoVerse_train_stage2_mcqa_test_eval_50.json'
test_data_path = f'/mnt/petrelfs/zhouxiao/project/TCGA/dataset_pp/PathoVerse_train_stage2_mcqa_test_{cat}.json'

# ckpt_out_path = 's3://zhouxiao/ckpt'
ckpt_out_path = None

work_dir = f'/mnt/petrelfs/zhouxiao/project/TCGA/train_mcqa_qwen3_8b_conv_qformer_{setting}_{cat}/'
vis_name = f'qwen3_8b_conv_qformer_{setting}_{cat}'
