...
train_data_path = '/mnt/petrelfs/zhaoweike/project/TCGA/dataset_pp/data_pipeline/tcga_kg_train/supercategories/mcqa_mutation_train.json'
val_data_path = '/mnt/petrelfs/zhaoweike/project/TCGA/dataset_pp/data_pipeline/tcga_kg_test/supercategories/mcqa_mutation_test.json'
test_data_path = '/mnt/petrelfs/zhaoweike/project/TCGA/dataset_pp/data_pipeline/tcga_kg_test/supercategories/mcqa_mutation_test.json'
...
work_dir = f'/mnt/petrelfs/zhaoweike/project/TCGA/train_s2_multitask_all_qwen3_{model_size}_vl_{model_type}_{setting}_mut_kg/'
vis_name = f'qwen3_{model_size}_vl_multitask_all_{model_type}_{setting}_kg'
# vis_name = None
...
visualizer = None if vis_name is None else dict(
    ...
    vis_backends=[
        dict(
            ...
            init_kwargs=dict(
                project='pathoverse_multitask_mut',
                name=vis_name
            )
        )
    ]
