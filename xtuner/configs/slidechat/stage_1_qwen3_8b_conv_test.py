...
ckpt_path = '/mnt/petrelfs/zhouxiao/project/TCGA/train_capgen_qwen3_8b_conv_alignment/iter_500.pth'
# ckpt_path = None
...
work_dir = f'/mnt/petrelfs/zhouxiao/project/TCGA/train_capgen_qwen3_8b_conv_{setting}/'

val_output_path = work_dir + 'val_results'
test_output_path = work_dir + 'test_results_sample_iter_5873'
