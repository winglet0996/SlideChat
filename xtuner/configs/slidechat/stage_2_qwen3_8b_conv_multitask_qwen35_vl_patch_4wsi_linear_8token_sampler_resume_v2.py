...
train_data_path = '/data/wg_workspace/projects/TCGA/data_pipeline_v2/pathoverse_v2/train.json'
val_data_path = '/data/wg_workspace/projects/TCGA/data_pipeline_v2/pathoverse_v2/test.json'
test_data_path = '/data/wg_workspace/projects/TCGA/data_pipeline_v2/pathoverse_v2/test.json'
