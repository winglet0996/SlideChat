...
head_scaling = (0, 0, 0.5) # regression, survival, wsi_projector
lora_r = 128
lora_alpha = 128
run_suffix = 'sampler'
...
if setting == 'lora':
    ...
    save_best_metrics = None
    # ckpt_path = None
    ckpt_path = '/mnt/petrelfs/zhaoweike/project/TCGA/9B_multimodal_lora_wo_knowledge_v12_4token_4wsi_linear_lora_r128_a128_sampler/iter_17000.pth'
    lr = 2e-5
    freeze_llm = True
    max_epochs = 3
...
ablation_tag = f'{patch_keep_tokens}token_{wsi_source_tag}_{patch_position_encoding}'
if setting == 'lora':
