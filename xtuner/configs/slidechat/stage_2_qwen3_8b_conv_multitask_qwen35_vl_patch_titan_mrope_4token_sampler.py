...
patch_position_encoding = 'mrope'  # 'linear' or 'mrope'
run_suffix = 'sampler'
...
if setting == 'alignment':
    ...
    # ckpt_path = None
    ckpt_path = '/mnt/petrelfs/zhaoweike/project/TCGA/9B_multimodal_alignment_wo_knowledge_v12_4token_titan_mrope_sampler/iter_2000.pth'
    max_epochs = 3
