...
if setting == 'lora':
    ...
    save_best_metrics = None
    # ckpt_path = None
    ckpt_path = '/mnt/petrelfs/zhaoweike/project/TCGA/9B_multimodal_lora_wo_knowledge_v12_4token_4wsi_linear_lora_r128_a128_sampler/iter_6000.pth'
    lr = 2e-5
    freeze_llm = True
    max_epochs = 3
...
# Patch attention export. Only used in test/predict mode; keep disabled for normal eval.
save_patch_attention_h5 = False
