...
def main():
    ...
    eval_data_path = '/mnt/petrelfs/zhouxiao/project/TCGA/dataset_pp/PathoVerse_train_stage1_caption_test.json'
    output_path = '/mnt/petrelfs/zhouxiao/project/TCGA/SlideChat/xtuner/configs/slidechat/eval_samples.py'
    sample_num = 20
    seed = 42
